...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--y_only",
        action="store_true",
        help="Train guidance model with only the target column"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="When sampling: how many rows to generate"
    )
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default=None,
        help="Path to checkpoint (.pth) for sampling or fine-tuning"
    )
    parser.add_argument(
        "--report",
        action="store_true",
        help="In sampling mode: run multiple trials and report mean±std"
    )
    parser.add_argument(
        "--num_runs",
        type=int,
    ...
    # Delegate to the actual tabdiff.main entrypoint
    tabdiff_main(args)
