...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Name of the dataset (must correspond to a folder under data/)"
    )
    parser.add_argument(
        "--mode", type=str, choices=["train", "sample"],
        default="train", help="Mode: train or sample"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Experiment name (used for saving checkpoints & logs)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="When in sample mode: number of synthetic samples to generate"
    )
    parser.add_argument(
        "--ckpt_path", type=str, default=None,
        help="Path to a .pth checkpoint (for sampling or fine-tuning)"
    )
    parser.add_argument(
